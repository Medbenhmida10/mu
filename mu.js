(function () {
 ...
 /*--------------------------------------------------------------------------------------------------------------- */
        ...
        div0.innerHTML = '<script  id="oView' + widgetName + '" name="oView' + widgetName + '" type="sapui5/xmlview"><mvc:View controllerName="myView.Template" xmlns:core="sap.ui.core" xmlns:mvc="sap.ui.core.mvc" xmlns="sap.m"> <SearchField width="auto"  value="{search>/query}" liveChange=".onLiveChange" /> <Tree  items="{' + widgetName + '>/}" mode="MultiSelect" selectionChange="onSelect"><StandardTreeItem title="{' + widgetName + '>text}"/></Tree></mvc:View></script>'
